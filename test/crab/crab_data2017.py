...
config.General.workArea = 'crab3Submission_Data_0108'
config.General.requestName = ''

config.section_('JobType')
config.JobType.psetName = '../recHitTree_cfg.py'
config.JobType.pyCfgParams = ['inputType=data', 'year=2017', 'doReco=ON', 'noiseFilter=ON']
...
config.Data.unitsPerJob = 4 #without '' since it must be an int
config.Data.splitting = 'LumiBased'
config.Data.publication = False
#config.Data.runRange = '317626-317696'
...
if __name__ == '__main__':
    ...
    requestNameList = ['ZeroBias_Run2017E-v1_RAW'
                       ]


    inputDatasetList = ['/ZeroBias/Run2017E-v1/RAW'
                        ]
